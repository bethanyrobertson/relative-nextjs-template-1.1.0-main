...
import ProductsDataRaw from 'src/data/products.json';
...
interface Product {
  image: string;
  specifications: Record<string, SpecificationSectionProps['specifications']>;
}
...
const ProductsData = ProductsDataRaw as ProductsDataType;
        ...
        <div className="flex-1 space-y-20">
          {Object.entries(product.specifications).map(([key, value]) => (
            <SpecificationSection
              ...
              specifications={value as SpecificationSectionProps['specifications']}
            />
          ))}
        </div>
      </div>
