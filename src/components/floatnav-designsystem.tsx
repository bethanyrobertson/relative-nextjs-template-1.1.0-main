...
const sections = [
  ...
  { id: "integration", label: "Integration", icon: Star },
  { id: "nextsteps", label: "Next Steps", icon: MessageCircle },
]

export default function FloatNavDesignSystem() {
            ...
            {sections.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`floatnav-item flex items-center gap-1 md:gap-2 px-2 md:px-3 py-2 rounded-full transition-all duration-200 whitespace-nowrap ${
                    isActive
